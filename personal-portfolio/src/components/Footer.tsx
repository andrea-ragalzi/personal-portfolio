...
const AppFooter = () => {
    ...
    return (
        <footer className="mt-10 mb-10 md:mb-5 sm:mb-0">
            <div className="flex flex-col justify-center items-center sm:mb-28">
                ...
                <div className="text-palette-900 dark:text-palette-400 text-center">
                    <p className="text-base md:text-xl">Made with TS, React, TailwindCSS, Sass and 🩵</p>
                    <p>&copy; {new Date().getFullYear()} Andrea Ragalzi</p>
                </div>
            </div>
        </footer>
    );
